...
CREATE TABLE Pais (
    codigo_pais NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre      VARCHAR2(100) NOT NULL
);

CREATE TABLE Confederacion (
    codigo_confederacion NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre               VARCHAR2(100) NOT NULL
);

CREATE TABLE Posicion (
    codigo_posicion NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre          VARCHAR2(50) NOT NULL
);

CREATE TABLE Usuario (
    codigo_usuario NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
...
CREATE TABLE Grupo (
    codigo_grupo NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
...
CREATE TABLE Ciudad (
    codigo_ciudad NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre        VARCHAR2(100) NOT NULL,
...
CREATE TABLE Seleccion (
    codigo_seleccion     NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre               VARCHAR2(100) NOT NULL,
...
CREATE TABLE Bitacora (
    codigo_bitacora  NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
...
CREATE TABLE Estadio (
    codigo_estadio NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre         VARCHAR2(100) NOT NULL,
...
CREATE TABLE Persona (
    codigo_persona   NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    nombre           VARCHAR2(100) NOT NULL,
...
CREATE TABLE Partido (
    codigo_partido NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 100) PRIMARY KEY,
    fecha          DATE         NOT NULL,
